...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      <p className='mb-8 max-w-md'>This is a mern app where you can experience the best design</p>
      <button onClick={()=>navigate('/login',{state : "Sign Up"})} className='border border-gray-500 rounded-full px-8 py-2.5
